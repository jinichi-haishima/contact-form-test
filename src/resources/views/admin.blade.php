...
<div class="admin-container">
    ...
    <section class="search-section">
        ...
        <div class="search-item">
            <input type="text" name="keyword" class="form-control" placeholder="名前やメールアドレスを入力" value="{{ request('keyword') }}">
        </div>
        <div class="search-item">
        ...
        <table class="search-result-table">
            ...
            <tr class="search-result-answer-tr">
                ...
                <td class="search-result-td">
                    <button type="button" class="detail-button" data-bs-toggle="modal" data-bs-target="#detailModal{{ $contact->id }}">詳細</button>
                </td>
            </tr>
            @endforeach
        </table>
