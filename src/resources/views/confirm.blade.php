...
<div class="confirm">
    ...
    <table class="confirm-table">
        <tr>
            ...
            <td class="confirm-table-td">{{ $contacts['last_name'] }} {{$contacts['first_name']}}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="confirm-table-td">{{ $contacts['email'] }}</td>
        </tr>
        <tr>
            <th class="confirm-table-th">電話番号</th>
            <td class="confirm-table-td">{{ $full_tel }}</td>
        </tr>
        <tr>
            <th class="confirm-table-th">住所</th>
            <td class="confirm-table-td">{{ $contacts['address'] }}</td>
        </tr>
        <tr>
            <th class="confirm-table-th">建物名</th>
            <td class="confirm-table-td">{{ $contacts['building'] }}</td>
        </tr>
        <tr>
            <th class="confirm-table-th">お問い合わせの種類</th>
            <td class="confirm-table-td">{{ $category->content ?? '未選択'}}</td>
        </tr>
        <tr>
            <th class="confirm-table-th">お問い合わせ内容</th>
            <td class="confirm-table-td">{{ $contacts['detail'] }}</td>
        </tr>
    </table>
